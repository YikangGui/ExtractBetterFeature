...
class Resnet():
    ...
    def resnet_v1(self, input_shape, depth, final_pool, dropout_rate_fc):
        ...
        outputs = Dense(100, activation='linear')(y)    
    ...
    def buildModel(self, version, input_shape, depth, final_pool, dropout_rate_fc):
        if version == 2:
            model = self.resnet_v2(input_shape=input_shape, depth=depth, num_classes=num_classes, final_pool=final_pool)
        else:
            model = self.resnet_v1(input_shape=input_shape, depth=depth, final_pool=final_pool, dropout_rate_fc=dropout_rate_fc)
        return model
